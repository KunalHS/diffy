...
var (
	...
	styleSelectedDimmed = lipgloss.NewStyle().Background(lipgloss.Color("#334155")).Foreground(lipgloss.Color("#CBD5E1"))
	styleSearchBox      = lipgloss.NewStyle().Foreground(lipgloss.Color("#E5E7EB")).Background(lipgloss.Color("#111827"))
	styleSearchMatch    = lipgloss.NewStyle().Foreground(lipgloss.Color("#111827")).Background(lipgloss.Color("#FACC15"))
	styleSearchCurrent  = lipgloss.NewStyle().Foreground(lipgloss.Color("#111827")).Background(lipgloss.Color("#F97316")).Bold(true)
...
func sidebarSelectionStyle(diffFocused bool) lipgloss.Style {
	if diffFocused {
		return styleSelectedDimmed
	}
